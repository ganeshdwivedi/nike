...
const HeroAfter = () => {
    return (
        <div className="flex flex-col md:flex-row p-5 overflow-hidden">
            ...
            <div className="w-full sm:bg-center md:w-1/2 h-[70vh] md:h-[100vh] bg-cover relative mx-2 bg-[url('https://static.nike.com/a/images/f_auto,cs_srgb/w_960,c_limit/2955113a-ada1-4dff-bb5a-a60ac84cf8ad/image.jpg')]">
